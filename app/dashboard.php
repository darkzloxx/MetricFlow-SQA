Genera la estructura $DATA consumida por el frontend (ECharts) paratableros de métricas, manteniendo compatibilidad con claves existentes.Lorenzo Teppa2025 CoDevItMIT1.0.0--------------------------------------------------------------------------Genera la estructura $DATA consumida por el frontend (ECharts) paratableros de métricas, manteniendo compatibilidad con claves existentes.Lorenzo Teppa2025 CoDevItMIT1.0.0--------------------------------------------------------------------------<?php
...
<body>
  ...
  <script>
    ...
    // ✅ Cerrar la conexión SSE cuando se navega fuera del dashboard
