...
// Manejo de login simple: recibe email y (opcional) nombre desde login.js
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'])) {
    ControlAcceso::creaSesion(trim($_POST['email']), $_POST['nombre'] ?? null);
                ...
                <article>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h5>Bienvenido</h5>
                            <p>Estimado usuario: Bienvenido a la aplicaci&oacute;n MetricFlow SQA, una aplicaci&oacute;n desarrollada en la UARG-UNPA.</p>
