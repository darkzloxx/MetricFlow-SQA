...
<head>
    ...
    <style>#errorFechas{display:none;}</style>
</head>
...
<div class="card shadow-sm">
    <div class="card-header"><h3>Actualizar Iteración</h3></div>
    ...
    <div class="card-footer text-right">
        ...
        <a href="iteraciones.php" class="btn btn-outline-danger"><span class="oi oi-x"></span> Cancelar</a>
    </div>
</div>
</form>
</div>
