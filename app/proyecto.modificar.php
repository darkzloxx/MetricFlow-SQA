...
<body>
    ...
    <div class="container">
        <form action="proyecto.modificar.procesar.php" method="post">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <textarea class="form-control" name="descripcion" id="inputDescripcion" placeholder="Ingrese una breve Descripcion" rows="5" cols="40"><?= $Proyec['descripcion']; ?></textarea>
