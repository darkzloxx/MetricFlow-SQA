...
<html>
    <head>
        ...
        <title><?php echo Constantes::NOMBRE_SISTEMA; ?> - Tarea</title>
                        ...
                        <tr>
                            ...
                            foreach ($proyecto as $Proyec) { ?>
                                ...
                                <td>
                                    ...
                                    <a title="Modificar" href="tarea.modificar.php?id=<?= $Proyec['id_tarea']; ?>">
                                        <button type="button" class="btn btn-outline-warning">
                                            <span class="oi oi-pencil"></span>
                                        </button>
                                    </a>
                                    <a title="Eliminar" href="tarea.eliminar.php?id=<?= $Proyec['id_tarea']; ?>">
